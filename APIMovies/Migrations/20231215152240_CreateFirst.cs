    ...
    public partial class CreateFirst : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Movie_Types", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Movie_Types_Movies_IdMovie",
                        column: x => x.IdMovie,
                        principalTable: "Movies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Movie_Types_Types_IdType",
                        column: x => x.IdType,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Movie_Types_IdMovie",
                table: "Movie_Types",
                column: "IdMovie");

            migrationBuilder.CreateIndex(
                name: "IX_Movie_Types_IdType",
                table: "Movie_Types",
                column: "IdType");
        }
